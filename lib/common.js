...
exports.RecordLayerLength = 5;
exports.HandshakeHeaderLength = 4;
...
exports.RevHandshakeType = Rev(exports.HandshakeType);
...
exports.checkBuffer = function(a) {
  assert(Buffer.isBuffer(a));
  return a;
};

exports.BufferXOR = function(a, b) {
  assert(Buffer.isBuffer(a));
