...
var Finished = {
  decode: function(buf, cipher, key, write_iv) {
    ...
    var encrypted_finished = encrypted_finished_and_tag.slice(0, 16);
    var tag = encrypted_finished_and_tag.slice(-16);
    var seq = new Buffer('0000000000000000', 'hex');
    var encrypted_record_header = new Buffer('1603030000', 'hex');
    encrypted_record_header.writeUInt16BE(4 + 12, 3);
  ...
  encode: function(obj, cipher, key, write_iv) {
    ...
    new_encrypted_record_header.writeUInt16BE(4 + 12 + 16, 3);
